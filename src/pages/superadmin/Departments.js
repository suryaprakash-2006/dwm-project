...
const INITIAL_DEPARTMENTS = [
  ...
  { id: 4,  name: "NPD Design",                        headCount: 4, description: "New product development"                   },
  { id: 5,  name: "Mechatronics",                      headCount: 5, description: "Mechanical & electronics integration"       },
  { id: 6,  name: "Quality Assurance",                 headCount: 4, description: "Quality control & assurance"                },
  { id: 7,  name: "Customer Service",                  headCount: 6, description: "Customer support & service"                 },
  { id: 8,  name: "Project Management",                headCount: 3, description: "Project planning & execution"               },
  { id: 9,  name: "Total Plant Maintenance",           headCount: 7, description: "Plant maintenance & upkeep"                 },
  { id: 10, name: "Product Assembly",                  headCount: 9, description: "Product assembly operations"                },
  { id: 11, name: "Project Assembly",                  headCount: 6, description: "Project-specific assembly"                  },
  { id: 12, name: "Machining Division",                headCount: 8, description: "CNC & machining operations"                 },
  { id: 13, name: "Sheet Metal Division",              headCount: 7, description: "Sheet metal fabrication"                    },
  { id: 14, name: "Powder Coating",                    headCount: 4, description: "Surface finishing & coating"                },
  { id: 15, name: "Human Resource",                    headCount: 3, description: "HR & people operations"                     },
  { id: 16, name: "Planning & Engineering Innovation", headCount: 5, description: "Planning & innovation engineering"          },
  { id: 17, name: "Supply Chain Management",           headCount: 4, description: "Supply chain & procurement"                 },
  { id: 18, name: "Stores",                            headCount: 3, description: "Inventory & stores management"              },
];
